        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.status == 200 && Array.isArray(result.data)) {
                    ...
                    $('#courseSyllabus').append("<div class='row no-data'><div class='col-sm-12 align-items-center'><h5 class='text-center m-0'>Sorry your syllabus isn't updated yet</h5></div</div>");
                }
            },
            error: function (error) {
                alert("Request Failed with status: "+error.status);
        ...
        if (files) {
            $.each(files, function (key, value) {
                ...
                && (courseLevel == value.level || courseLevel == "0")) {
                    ...
                    div = div + "</div>";
                    div = div + "<div class='col-sm-6 d-flex justify-content-start align-middle download' style='cursor:pointer;' data-type='"+fileType+"' data-url='" + value.url + "'>";
                    div = div + "<h6>" + value.title + "</h6>";
                    div = div + "</div>";
                    div = div + "<div class='col-sm-5 d-flex align-items-center justify-content-end pr-4'>";
