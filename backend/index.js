			...
			try {
				...
				if (activity.type == 'Notification') {
					act = `<div class=" card px-3 py-3 mt-2">
						...
						<div class="col-6"><a data-toggle="modal" data-target="#followed" data-id=${activity.id}> ${activity.followers.length} followers `
						for (let i = 0; i < 5; i++) {
						...
						<div class="col-3 mt-3 forward"><button type="button" data-toggle="modal" data-target="#forward" data-type="Notification" data-id=${activity.id} class="btn btn-light"><i class="fas fa-share-square"></i> Forward To</button></div>					
					</div>
				</div>`;
					...
					act+= `<div class="col-3 mt-3"><i class="fab fa-telegram-plane"></i> ${activity.sent_to} Send To</div>
						...
						<div class="col-3 mt-3 forward"><button type="button" data-toggle="modal" data-target="#forward" data-type="questionnaire" data-id=${activity.id} class="btn btn-light"><i class="fas fa-share-square"></i> Forward To</button></div>				
					</div>
				</div>`;
					...
					act += `<div class="col-3 mt-3"><i class="fab fa-telegram-plane"></i> ${activity.sent_to} Send To</div>
							<div class="col-3 mt-3 forward"><button type="button" data-toggle="modal" data-target="#forward" data-type="videoConference" data-id=${activity.id} class="btn btn-light"><i class="fas fa-share-square"></i> Forward To</button></div>			
				</div>
			</div>`;      		
					...
					act += `<div class="col-3 mt-3"><i class="fab fa-telegram-plane"></i> ${activity.sent_to} Send To</div>
					<div class="col-3 mt-3 forward"><i class="fas fa-comments"></i> ${typeof activity.comments_counts !== 'undefined'? activity.comments_counts: activity.comments_count} Comments</div>					
				</div>
			</div>`;
					...
					if (endtime >= new Date()) {
						...
						act += `
								...
								<div class="col-3 mt-3 answered"><button type="button" data-toggle="modal" data-target="#answered" data-type="Answered" data-id=${activity.id} class="btn btn-light"><i class="far fa-check-square"></i> ${activity.answered} Attempted</button></div>
								<div class="col-3 mt-3 unanswered"><button type="button" data-toggle="modal" data-target="#answered" data-type="Unanswered" data-id=${activity.id} class="btn btn-light"><i class="far fa-window-close"></i> ${activity.sent_to - activity.answered} Unattempted</button></div>
								<div class="col-3 mt-3 forward"><button type="button" data-toggle="modal" data-target="#forward" data-type="Subjective" data-id=${activity.id} class="btn btn-light"><i class="fas fa-share-square"></i> Forward To</button></div>					
							</div>
						</div>`;
						...
						act += `		<div class="col-3 mt-3 forward"><button type="button" data-toggle="modal" data-target="#forward" data-type="Subjective" data-id=${activity.id} class="btn btn-light"><i class="fas fa-share-square"></i> Forward To</button></div>
									</div>
								</div>`;						
