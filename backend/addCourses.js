            ...
            success: function (result) {
                ...
                if (result.status == 200) {
                    ...
                    $.each(result.data, function (key, value) {
                        ...
                        div = div + "<button type='button' class='btn btn-primary' style='cursor:pointer;' data-toggle='modal' data-target='#courseModal' data-subject='"+value.id+"' data-dept='" + JSON.stringify(dept) + "'>+</button>";
                        div = div + "</div></div></div></div>";

                        div1 = div1 + "<li class='course' style='cursor:pointer;' data-toggle='modal' data-target='#courseModal' data-subject='"+value.id+"' data-dept='" + JSON.stringify(dept) + "'>"+value.name+"</li>";
