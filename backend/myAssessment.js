$(document).ready(function () {
    ...
    function displayCards(data = []){
        ...
        $.each(data, function (key, value) {
            ...
            div += "<div class='col-2 d-flex justify-content-center'><button class='btn btn-secondary text-white' style='cursor:not-allowed;border:1px solid gray;' data-toggle='tooltip' data-placement='top' title='No Result Yet'>View Result</button></div>";
